...
def analyze_crm_monday_strategies():
    """Analyze CRM 3rd Monday to 4th Monday strategies with RSI enhancements"""
    ...
    print("CRM 3rd Monday → 4th Monday Trading Strategies")
    print("=" * 80)
    ...
    for year in range(2022, 2026):  # 2022-2025
        for month in range(1, 13):
            ...
            buy_monday = get_nth_monday_of_month(year, month, 3)
            sell_monday = get_nth_monday_of_month(year, month, 4)
    ...
    # 1. Simple Strategy - Buy every 3rd Monday, sell every 4th Monday (or next 1st Monday)
    ...
    strategies['Simple'] = {
        ...
        'description': 'Buy every 3rd Monday, sell every 4th Monday'
    }
    ...
    if len(best_strategy['trades']) > 0:
        best_strategy['trades'].to_csv('crm_monday_trades.csv', index=False)
        print(f"\n✅ Detailed trades saved to 'crm_monday_trades.csv'")
    ...
    if comparison_data:
        ...
        comparison_df.to_csv('crm_strategy_comparison.csv', index=False)
        print(f"✅ Strategy comparison saved to 'crm_strategy_comparison.csv'")
