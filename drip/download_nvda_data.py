...
def download_nvda_data():
    """Download 3 years of NVDA data with 15-minute intervals"""
    ...
    base_url = "https://api.polygon.io/v2/aggs/ticker/NVDA/range/15/minute"
    ...
    # Save to CSV
    filename = 'nvda_15min_data.csv'
    final_df.to_csv(filename, index=False)
    
    print(f"✅ NVDA data saved to {filename}")
    ...
    with open('nvda_data_summary.json', 'w') as f:
        import json
        json.dump(summary, f, indent=2)
    
    print(f"📋 Summary saved to nvda_data_summary.json")
