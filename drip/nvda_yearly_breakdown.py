...
def analyze_nvda_yearly_breakdown():
    """Detailed year-by-year breakdown of NVDA strategy performance"""
    
    # Load the detailed trades
    trades_df = pd.read_csv('nvda_monday_trades.csv')
    ...
    print("NVDA Strategy vs Buy & Hold: Year-by-Year Comparison (2nd→3rd Monday)")
    print("=" * 90)
    ...
    for year in sorted(trades_df['year'].unique()):
        ...
        if year == 2022:
            print(f"  📉 Tough start: Market volatility, strategy struggled early")
        elif year == 2023:
            print(f"  🚀 AI boom year: Strategy performed well but B&H soared")
        elif year == 2024:
            print(f"  📈 Solid gains: Strategy captured good momentum")
        elif year == 2025:
            print(f"  💪 Strong performance: High win rate, consistent gains")
